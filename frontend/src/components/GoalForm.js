...
const GoalForm = ({ onCancel }) => {
  ...
  const orderSubmit = (data) => {
    ...
    const startFormattedDate = dayjs(dateRange[0].startDate).format(
      "YYYY-MM-DDTHH:mm:ss.SSSZ"
    );
    const endFormattedDate = dayjs(dateRange[0].endDate).format(
      "YYYY-MM-DDTHH:mm:ss.SSSZ"
    );
            ...
            <ProductContainer key={index}>
              ...
              <div className="form-types">
                <div className="form-type">
                  ...
                  />
                  {errors[`options-${index}`]?.type === "required" && (
                    <small className="fail">Field is empty</small>
                  )}
                </div>
                          ...
                          onChange={(e) => {
                            ...
                            setSelectedProductNames(
                              (prevSelectedProductNames) =>
                                prevSelectedProductNames.includes(
                                  selectedProduct
                                )
                                  ? prevSelectedProductNames
                                  : [
                ...
                {selectedType === "Category" && (
                  <div className="form-category">
                          ...
                          onChange={(e) => {
                            ...
                            setSelectedCategoryNames(
                              (prevSelectedCategoryNames) =>
                                prevSelectedCategoryNames.includes(
                                  selectedCategory
                                )
                                  ? prevSelectedCategoryNames
                                  : [
                        ...
                        >
                          ...
                          {catOptions.categories.map((category) => (
                            <option
                              key={category}
                              value={category}
                              disabled={selectedCategoryNames.includes(
                                category
                              )}
                            >
                              {category}
                    ...
                    />
                    {errors[`category-${index}`]?.type === "required" && (
                      <small className="fail">Field is empty</small>
                    )}
                  </div>
                )}
